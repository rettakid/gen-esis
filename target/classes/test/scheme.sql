...
CREATE TABLE PACS_SERVICE_BLACKLIST (
	SERVICE_BLACKLIST_ID		INT(10) 		NOT NULL AUTO_INCREMENT,
	SERVICE_A_ID 				INT(10) 		NOT NULL,
	SERVICE_B_ID 				INT(10) 		NOT NULL,
	SERVICE_BLACKLIST_DESCR		VARCHAR(100) 	NOT NULL,

	PRIMARY KEY (SERVICE_BLACKLIST_ID),
	UNIQUE KEY SERVICE_BLACKLIST_ID(SERVICE_BLACKLIST_ID),
	FOREIGN KEY (SERVICE_A_ID) REFERENCES PACS_SERVICE(SERVICE_ID),
	FOREIGN KEY (SERVICE_B_ID) REFERENCES PACS_SERVICE(SERVICE_ID)
);
